        ...
        >
          ...
          >
            <li className="w-full flex justify-start items-center">
              <Link href={"/"} className="px-[10px] py-[8px] capitalize">
                Trang chủ
              </Link>
            </li>
            <li className="w-full flex justify-start items-center">
              <Link href={"/about"} className="px-[10px] py-[8px] capitalize">
                Giới thiệu
              </Link>
            </li>
            <li className="w-full flex flex-wrap justify-start items-center">
              <Link
                href={""}
                className="flex items-center px-[10px] py-[8px] capitalize"
              >
              ...
              {showSubMenu && (
                <Menu mode="vertical" items={items} style={{ width: 260 }} />
              )}
            </li>
            <li className="w-full flex justify-start items-center">
              <Link href={"/shop"} className="px-[10px] py-[8px] capitalize">
                Cửa hàng
              </Link>
            </li>
            <li className="w-full flex justify-start items-center">
              <Link href={"/contact"} className="px-[10px] py-[8px] capitalize">
                Liên hệ
              </Link>
            </li>
            <li className="w-full flex justify-start items-center">
              <Link
                href={"/recruitment"}
                className="px-[10px] py-[8px] capitalize"
              >
                Tuyển dụng
              </Link>
            </li>
            <li className="w-full flex justify-start items-center">
              <Link href={"/news"} className="px-[10px] py-[8px] capitalize">
                Tin tức
              </Link>
            </li>
          </ul>
